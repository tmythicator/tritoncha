...
(defn- audition-btn
  ...
  Examples: [audition-btn :lead-pluck \"♪ NOTE\" \"Single note\" #(state/play-test-note! :lead-pluck) false]."
...
(defn- drum-audition-buttons
  ...
  [inst-key]
  [:<>
   [audition-btn inst-key "♪ HIT" "Audition single drum hit" state/play-test-note! false]
   [audition-btn inst-key "♫ ROLL" "Audition drum roll" state/play-test-run! false]
   [audition-btn inst-key "≋ FILL" "Audition 8-step drum fill" state/play-test-arp! true]])
...
(defn- fx-audition-buttons
  ...
  [inst-key]
  [:<>
   [audition-btn inst-key "♪ SHOT" "Audition single one-shot FX" state/play-test-note! false]
   [audition-btn inst-key "♫ RUN" "Audition descending pitch run" state/play-test-run! false]
   [audition-btn inst-key "≋ ARP" "Audition rapid FX strobe" state/play-test-arp! false]
   [audition-btn inst-key "≈ CHORD" "Audition FX burst" state/play-test-chord! true]])
...
(defn- tonal-audition-buttons
  ...
  [inst-key poly?]
  [:<>
   [audition-btn inst-key "♪ NOTE" "Audition single sustained note" state/play-test-note! false]
   [audition-btn inst-key "♫ RUN" "Audition melodic 5-note scale run" state/play-test-run! false]
   [audition-btn inst-key "≋ ARP" "Audition rolling 8-step arpeggio" state/play-test-arp! false]
   [audition-btn inst-key "≈ CHORD"
    (if poly?
      "Audition polyphonic sustained chord"
      "Audition fast broken chord strum")
    state/play-test-chord! true]])
