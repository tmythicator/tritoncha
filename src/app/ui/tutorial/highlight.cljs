...
(def ^:private live-fns
  #{"stack!" "unstack!" "l!" "loop!" "stop-loop!" "clear-loops!"
    "pat" "pattern" "euc" "euclid" "d" "deg" "chord" "arp" "progression" "prog" "scale" "sc"
    "fast" "slow" "rev" "shift" "rot" "rotate" "take-steps" "every-n" "sometimes" "sometimes-by"
    "transpose" "oct-shift"
    "set-key!" "current-key" "mod-all!" "modulate-all!" "tr-all!" "transpose-all!"
    "mute!" "m!" "unmute!" "u!" "solo!" "so!" "unsolo!" "unso!"
    "undrum!" "redrum!" "toggle-drums!"
    "unbass!" "rebass!" "toggle-bass!"
    "unlead!" "relead!" "toggle-leads!"
    "unpad!" "repad!" "toggle-pads!"
    "v!" "set-volume!" "toggle-bus!" "mute-bus!" "unmute-bus!"
    "b!" "set-bpm!" "play!" "jam!" "play-track-at!" "track!" "toggle-play!"
    "cycle-jam!" "cycle-jam" "next-jam!" "next-jam" "nextjam" "prev-jam!" "prev-jam" "prevjam" "jam-list" "stop!"
    "click!" "toggle-click!" "set-click!"
    "mod!" "set-drum-mode!" "vel!" "set-track-vel!"
    "f!" "set-filter-cutoff!" "q!" "set-filter-q!" "sw!" "sweep-filter!"
    "dist!" "set-distortion!" "bitcrush!" "chorus!" "sidechain!"
    "fb!" "set-delay-feedback!" "dt!" "set-delay-time!" "wet!" "set-reverb-wet!"
    "drive-mode!" "set-drive-mode!" "reverb-mode!" "set-reverb-mode!"
